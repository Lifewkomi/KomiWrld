...
var nodeRequest = require("./_chunks-cjs/node-request.cjs");
...
function createRequester(initMiddleware, httpRequest) {
  const loadedMiddleware = [], middleware = middlehooks.reduce(
    ...
    {
      processOptions: [nodeRequest.processOptions],
      validateOptions: [nodeRequest.validateOptions]
    }
  );
...
const getIt = (initMiddleware = [], httpRequest = nodeRequest.httpRequester) => createRequester(initMiddleware, httpRequest), environment = "node";
exports.adapter = nodeRequest.adapter;
