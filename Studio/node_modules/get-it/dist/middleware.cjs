...
var http = require("http"), https = require("https"), require$$0 = require("tty"), require$$1 = require("util"), nodeRequest = require("./_chunks-cjs/node-request.cjs"), progressStream = require("progress-stream"), allowed = require("is-retry-allowed");
function _interopDefaultCompat(e) {
  return e && typeof e == "object" && "default" in e ? e : { default: e };
}
var require$$0__default = /* @__PURE__ */ _interopDefaultCompat(require$$0), require$$1__default = /* @__PURE__ */ _interopDefaultCompat(require$$1), progressStream__default = /* @__PURE__ */ _interopDefaultCompat(progressStream), allowed__default = /* @__PURE__ */ _interopDefaultCompat(allowed);
...
var defaultShouldRetry = (err, _num, options) => options.method !== "GET" && options.method !== "HEAD" || err.response && err.response.statusCode ? !1 : allowed__default.default(err);
...
function buildKeepAlive(agent2) {
  return function(config = {}) {
    ...
    return {
      finalizeOptions,
      onError: (err, context) => {
        if ((context.options.method === "GET" || context.options.method === "POST") && err instanceof nodeRequest.NodeRequestError && err.code === "ECONNRESET" && err.request.reusedSocket) {
...
exports.processOptions = nodeRequest.processOptions;
exports.validateOptions = nodeRequest.validateOptions;
