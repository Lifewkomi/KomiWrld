...
var jsxRuntime = require("react/jsx-runtime"),
  toolkit = require("@portabletext/toolkit"),
  react = require("react");
const defaultLists = {
    number: ({
      children
...
const hidden = {
  ...
  DefaultHardBreak = () => /* @__PURE__ */jsxRuntime.jsx("br", {}),
  defaultBlockStyles = {
    normal: ({
      children
    }) => /* @__PURE__ */jsxRuntime.jsx("p", {
    ...
    blockquote: ({
      children
    }) => /* @__PURE__ */jsxRuntime.jsx("blockquote", {
      children
    }),
    h1: ({
      children
...
function PortableText({
  ...
  const handleMissingComponent = missingComponentHandler || noop,
    ...
    nested = toolkit.nestLists(blocks, listNestingMode || toolkit.LIST_NEST_MODE_HTML),
    components = react.useMemo(() => componentOverrides ? mergeComponents(defaultComponents, componentOverrides) : defaultComponents, [componentOverrides]),
    renderNode = react.useMemo(() => getNodeRenderer(components, handleMissingComponent), [components, handleMissingComponent]),
...
const getNodeRenderer = (components, handleMissingComponent) => {
  ...
  function renderBlock(node, index, key, isInline) {
    ...
    return Block === components.unknownBlockStyle && handleMissingComponent(unknownBlockStyleWarning(style), {
      nodeType: "blockStyle",
      type: style
    }), /* @__PURE__ */jsxRuntime.jsx(Block, _objectSpread(_objectSpread({}, props), {}, {
      value: props.node,
      renderNode
    }), key);
  }
...
`;
  ...
  function renderCustomBlock(node, index, key, isInline) {
    ...
    return Node ? /* @__PURE__ */jsxRuntime.jsx(Node, _objectSpread({}, nodeOptions), key) : null;
  }
  return renderNode;
};
